...
* under the License.
*/
package org.wso2.carbon.connector.integration.test.Wikipedia;
 ...
 */
public class WikipediaConnectorIntegrationTest extends ConnectorIntegrationTestBase {
    ...
    @Test(enabled = true, groups = {"wso2.ei"}, description = "Wikipedia test case")
